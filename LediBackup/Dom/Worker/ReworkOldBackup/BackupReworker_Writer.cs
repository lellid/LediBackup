...
namespace LediBackup.Dom.Worker.ReworkOldBackup
{
  public partial class BackupReworker
  {
    private class Writer
    {
      ...
      private BlockingCollection<WorkerItem> InputQueue = new BlockingCollection<WorkerItem>(MaxItemsInInputQueue);
      ...
      public bool HasEmptyInputQueue => 0 == InputQueue.Count && 0 == _numberOfWorkingWorkerLoops;
