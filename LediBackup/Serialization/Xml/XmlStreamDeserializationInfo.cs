...
#nullable restore
    ...
    public void AnnounceDeserializationEnd(object documentRoot, bool isFinalCall)
    {
    ...
    /// <param name="fullyQualifiedBaseTypeName">Fully qualified base type name. It is the short name of the assembly, comma, the full type name, comma, and the version. The string must not contain whitespaces. Example: 'AltaxoBase,LediBackup.Main.DocumentPath,0'.</param>
